    ...
    return (
        <main className="flex justify-center items-center min-h-screen p-4">
            <div className={`transition-opacity flex justify-center items-center flex-col gap-5 duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <Link href="/portfolio" className="border border-cyan-950 rounded-3xl px-7 py-1 text-base transition-colors duration-300 ease-in-out hover:bg-cyan-950 mt-3 hover:text-white text-center">Read it!</Link>
            </div>
        </main>
    )
}